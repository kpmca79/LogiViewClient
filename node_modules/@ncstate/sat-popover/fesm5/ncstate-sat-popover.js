import { ElementRef, Injectable, NgZone, Optional, Directive, ViewContainerRef, Input, Component, ViewEncapsulation, Inject, Output, ViewChild, TemplateRef, EventEmitter, HostListener, NgModule } from '@angular/core';
